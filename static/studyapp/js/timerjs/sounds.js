export default function () {
	...
	const forestAudio = new Audio('./static/studyapp/audio/forest.wav')
	const coffeeAudio = new Audio('./static/studyapp/audio/coffee.wav')
	const rainAudio = new Audio('./static/studyapp/audio/rain.wav')
	const fireAudio = new Audio('./static/studyapp/audio/fire.wav')
